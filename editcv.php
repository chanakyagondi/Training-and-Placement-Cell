...
<html>
    ...
    <table align="center" border="0" width="40" cellspacing="10" cellpadding="4">
        ...
        <tbody>
            ...
            <tr>
                <td>Name:</td>
                 <td><input type="text" name="highschoolname" value="<?php echo $row[schoolname]?>" required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><input type="number" name="highschoolpercentage" min="70" max="100" required/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Name:</td>
                <td><input type="text" name="secondaryeducationname" value="<?php echo $row[secondaryschoolname]?>" required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><input type="number" name="secondaryeducationpercentage" min="70" max="100" required/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Name:</td>
                <td><input type="text" name="undergraduationname" value="<?php echo $row[universityname]?>" required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
