...
<html>
    ...
    <table align="center" border="0" width="40" cellspacing="10" cellpadding="4">
        ...
        <tbody>
            ...
            <tr>
                <td>Percentage:</td>
                <td><?php echo $row[schoolpercentage]?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Name:</td>
                <td><?php echo $row[secondaryschoolname]?></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><?php echo $row[secondaryschoolpercentage]?></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Percentage:</td>
                <td><?php echo $row[universitypercentage]?></td>
            </tr>
            <tr>
                <td colspan="2"><hr></td>
            </tr>
