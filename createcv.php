...
<html>
    ...
    <table align='center' border="0" width="10" cellspacing="50" cellpadding="4">
        ...
        <tbody>
            ...
            <tr>
                <td>Name:</td>
                 <td><input type="text" name="highschoolname"  required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><input type="number" name="highschoolpercentage" min="0" max="100" required/></td>
            </tr>
            <tr>
                <td colspan="2">Secondary Education:</td>  
            </tr>
            <tr>
                <td>Name:</td>
                <td><input type="text" name="secondaryeducationname"  required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><input type="number" name="secondaryeducationpercentage" min="0" max="100" required/></td>
            </tr>
            <tr>
            ...
            <tr>
                <td>Name:</td>
                <td><input type="text" name="undergraduationname"  required/></td>
            </tr>
            <tr>
                <td>Percentage:</td>
                <td><input type="number" name="undergraduationpercentage" min="0" max="100" required/></td>
            </tr>
            <tr>
                <td colspan="2"><hr></td>
            </tr>
            ...
            <tr>
                <td>Publications:</td>
                <td><input type="text" name="publications"  required/></td>
            </tr>
            <tr>
                <td>Interests:</td>
